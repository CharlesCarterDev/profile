...
<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&size=20&duration=3200&pause=900&center=true&vCenter=true&width=640&lines=4M%2B+survey+records+schema-designed;Encrypted+SFTP+%E2%86%92+MongoDB%2C+fully+automated;-30%25+time+complexity+on+core+systems;Spec+first.+Then+the+code." alt="4M+ survey records schema-designed; encrypted SFTP to MongoDB, fully automated; -30% time complexity on core systems; spec first, then the code." />
</p>

<p align="center">
  <a href="https://linkedin.com/in/charles-carter-5b950430a"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn" /></a>
  <a href="mailto:charlescarter12012@gmail.com"><img src="https://img.shields.io/badge/Email-EA4335?style=for-the-badge&logo=gmail&logoColor=white" alt="Email" /></a>
  <img src="https://img.shields.io/badge/Birmingham,%20AL-1f6feb?style=for-the-badge&logo=googlemaps&logoColor=white" alt="Based in Birmingham, Alabama" />
  <img src="https://img.shields.io/badge/Open%20to-Remote%20%2F%20Contract-2ea043?style=for-the-badge" alt="Open to remote and contract work" />
</p>
...
<table align="center">
  <tr>
    <td align="center" width="25%"><h3>4M+</h3>survey records<br/>schema-designed</td>
    <td align="center" width="25%"><h3>166K+</h3>employee records<br/>ingested &amp; structured</td>
    <td align="center" width="25%"><h3>&minus;30%</h3>time complexity<br/>on core systems</td>
    <td align="center" width="25%"><h3>&minus;23%</h3>system<br/>load time</td>
  </tr>
</table>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/REST%20APIs-6E5494?style=flat-square" alt="REST APIs" />
  <img src="https://img.shields.io/badge/GIS%20Data-3EAF7C?style=flat-square" alt="GIS data" />
</p>

<details>
<summary><b>The full stack, by discipline</b></summary>
...
```mermaid
flowchart LR
    A["Client SFTP<br/>encrypted flat files"] --> B["Fetch + decrypt"]
    G["GIS / field data"] --> C
    B --> C["Parse and validate"]
    C --> D["Transform<br/>hierarchy construction"]
    D --> E[("MongoDB / SQL Server")]
    E --> F["Reporting and analytics"]
    C -.->|discrepancies| R["Reconciliation<br/>and integrity checks"]
    R -.-> D
```
